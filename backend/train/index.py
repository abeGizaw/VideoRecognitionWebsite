...
# Load or compute training mappings
jester_training_labels_df = pd.read_csv(jester_path_train)
jester_validation_labels_df = pd.read_csv(jester_path_validation)
jesterVideo_train_paths, jester_train_video_labels = load_training_data(jester_training_labels_df,jester_path_videos, "jester")

#Load or compute validation mappings
jester_validation_labels_df = pd.read_csv(jester_path_validation)
jesterVideo_val_paths, jester_val_video_labels = load_training_data(jester_validation_labels_df,jester_path_videos, "jester")
...
print(f"Unique training labels in Jester: {len(jester_unique_val_labels)}")
...
print(f"Jester most common training label: {jester_most_common_val_label} with {jester_most_common_val_count} videos out of {len(jester_val_label_counts)}.")
print(f"Jester least common training label: {jester_least_common_val_label} with {jester_least_common_val_count} videos out of {len(jester_val_label_counts)}.")
print(f"Jester proportion of most common training label: {jester_most_common_val_proportion} \n")
